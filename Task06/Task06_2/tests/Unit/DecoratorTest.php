...
namespace Uvarov\Tests;

use PHPUnit\Framework\TestCase;
use Uvarov\Task062\EconomyRoom;
use Uvarov\Task06_2\StandardRoom;
use Uvarov\Task06_2\SuiteRoom;
use Uvarov\Task06_2\InternetDecorator;
use Uvarov\Task06_2\BreakfastDecorator;
use Uvarov\Task06_2\FoodDeliveryDecorator;
use Uvarov\Task06_2\SofaDecorator;
